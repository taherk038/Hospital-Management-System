...
<nav class="navbar navbar-expand-lg navbar-dark fixed-top" id="mainNav" >
    <div class="container">
      ...
      <a class="navbar-brand js-scroll-trigger" href="#" style="margin-top: 10px;margin-left:-65px;font-family: 'IBM Plex Sans', sans-serif;"><h4><i class="fa fa-user-plus" aria-hidden="true"></i>&nbsp PROJECT HOSPITALS</h4></a>
...
<div class="container register" style="font-family: 'IBM Plex Sans', sans-serif;">
                <div class="row">
                    <!--<div class="col-md-3 register-left" style="margin-top: 10%;right: 5%">
                        <img src="https://w7.pngwing.com/pngs/897/924/png-transparent-hospital-health-care-medicine-physician-computer-icons-health.png" height="250px" width="1000px" alt=""/>
                        <h3>Welcome</h3>
                       
                    </div>-->
                    <div style="margin-top: 10%;right: 5%">
                        <img src="https://png.pngtree.com/element_our/20200702/ourlarge/pngtree-hospital-logo-pictures-image_2289645.jpg" height="140" width="135" alt=""/>
                        <pre> <h3 style="color:White;"> Welcome</h3></pre>
                                ...
                                <div class="row register-form">
                                    ...
                                    <div class="col-md-6">
                                        ...
                                        <div class="form-group">
                                            ...
                                            <input type="email" class="form-control" placeholder="Your Email *" id="email" name="email" pattern="[a-z0-9._%+-]+@[a-z0-9.-]+\.[a-z]{2,}$" />
                                        </div>
                                        <div class="form-group">
                                    ...
                                    <div class="col-md-6">
                                        ...
                                        <div class="form-group">
                                            <input type="tel" minlength="10" maxlength="10" name="contact" class="form-control" placeholder="Your Phone *" pattern="[0-9]{10}" title="Enter Only Numbers"  />
                                        </div>
                                        <div class="form-group">
